        ...
        <Modal
            ...
            <View
                ...
                <View style={{
                    ...
                    <Checkbox.Item status={checkedKitchen ? 'checked' : 'unchecked'} label="Kitchen printer" color="#df8f17" onPress={() => { setCheckedKitchen(!checkedKitchen) }} labelStyle={{
                        color: '#030303',
                    ...
                    <Checkbox.Item status={checkedReceipt ? 'checked' : 'unchecked'} label="Receipt printer" color="#df8f17" onPress={() => { setCheckedReceipt(!checkedReceipt) }} labelStyle={{
                        color: '#030303',
                        fontFamily: 'Montserrat-Light',
                        borderRadius: 24,
                        fontSize: 16,
