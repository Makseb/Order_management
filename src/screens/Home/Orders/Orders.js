                    ...
                    <View style={styles.containerHeader}>
                        ...
                        <TouchableWithoutFeedback onPress={() => SwitchBetweenAllInProgressReady("all")}>
                            <View style={[styles.containerAll,
                                ...
                                <Text style={[styles.headerText, { color: switchButton === 'all' ? '#df8f17' : '#b7b7b7' }]}>{translation("All")}</Text>
                            </View>
                        ...
                        <TouchableWithoutFeedback onPress={() => SwitchBetweenAllInProgressReady("inprogress")}>
                            <View style={[styles.containerInProgress,
                                ...
                                <Text style={[styles.headerText, { color: switchButton === 'inprogress' ? '#df8f17' : '#b7b7b7' }]}>{translation("In progress")}</Text>
                            </View>
                        </TouchableWithoutFeedback>
                        ...
                        <TouchableWithoutFeedback onPress={() => SwitchBetweenAllInProgressReady("ready")}>
                            <View style={[styles.containerReady,
                                ...
                                <Text style={[styles.headerText, { color: switchButton === 'ready' ? '#df8f17' : '#b7b7b7' }]}>{translation("Ready")}</Text>
                            </View>
                        </TouchableWithoutFeedback>
                    </View>
                    {/* second part */}
